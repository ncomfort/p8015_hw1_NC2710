...
The size of the dataset, prob2\_df, is 1000 rows (observations) and 5 columns (variables). The mean of x is -0.0106382 and the median of x is -0.031318. The proportion of cases for which the logical vector is TRUE is 0.49.
...
plot_1 + labs(title = "Scatterplot 1 of y vs x", subtitle = "Plot 1 of 3", x = "x", y = "y", color = "Is x + y > 0?")
```
